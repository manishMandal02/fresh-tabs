...
const Switch = ({ id, checked, disabled, onChange, size = 'medium' }: Props) => {
  const switchSize =
    ...
    <form>
      <div className="flex items-center">
        <SwitchRadix.Root
          ...
          className={`${switchSize} rounded-full relative  transition-all duration-200 data-[state=checked]:bg-brand-primary/75 outline-none cursor-default disabled:cursor-not-allowed`}>
          <SwitchRadix.Thumb
